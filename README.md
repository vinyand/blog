<img src="./Downloads/index.jpg" alt="imagem">
...
## Back-end feito no strap.io

# Você pode usar o administrador strapi.io para postar.

### para instalar use `npx create-strapi-app@latest my-project --quickstart`

### para acessar area de adm no strapi é so usar `http://localhost:1337/admin/`

### documentação do strapi `https://docs.strapi.io/developer-docs/latest/getting-started/quick-start.html#_1-install-strapi-and-create-a-new-project`
